...
When we unpack the data of example volume, we see that dicom files with the suffix dcm are in the directory `TCGA-19-1787/04-20-2002-NA-NR CT HEAD W CE-97133/2.000000-Head Vol.  1.5  H40s ST-51391`. For simplicity I rename this directory just to DICOM. 
From the DICOM header we can see that it is a scan on SIEMENS Sensation Cardiac 64 CT machine. It contains 124 slices with the thickness of 1.5mm of the dimension 512x512, the voxel sizes are (0.64453125mm, 0.64453125mm, 1.5mm).
